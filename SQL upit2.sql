SET IDENTITY_INSERT Ministarstvo ON;

INSERT INTO Ministarstvo (id, ime, sprat) VALUES (1,'Ministarstvo Magije', 7);
INSERT INTO Ministarstvo (id, ime, sprat) VALUES (2,'Ministarstvo finansija', 5);
INSERT INTO Ministarstvo (id, ime, sprat) VALUES (3,'Ministarstvo gradjevine', 4);

SET IDENTITY_INSERT Ministarstvo OFF;

SET IDENTITY_INSERT Odsek ON;

INSERT INTO Odsek (id, Ime, [Br. sprata], Ministarstvoid) VALUES (1,'Odsek za misterije', 1, 1);
INSERT INTO Odsek (id, Ime, [Br. sprata], Ministarstvoid) VALUES (2,'Odsek za sprovođenje magijskih zakona', 2, 1);
INSERT INTO Odsek (id, Ime, [Br. sprata], Ministarstvoid) VALUES (3,'Odsek za magijske nesreće i katastrofe ', 3, 1);
INSERT INTO Odsek (id, Ime, [Br. sprata], Ministarstvoid) VALUES (4,'Odsek za regulaciju i kontrolu magijskih stvorenja ', 4, 1);
INSERT INTO Odsek (id, Ime, [Br. sprata], Ministarstvoid) VALUES (5,'Odsek za međunarodnu magijsku saradnju', 5, 1);
INSERT INTO Odsek (id, Ime, [Br. sprata], Ministarstvoid) VALUES (6,'Odsek magijskog transporta', 6, 1);
INSERT INTO Odsek (id, Ime, [Br. sprata], Ministarstvoid) VALUES (7,'Odsek za magijske igre i sportove', 7, 1);

INSERT INTO Odsek (id, Ime, [Br. sprata], Ministarstvoid) VALUES (8,'Odsek za poreze', 1, 2);
INSERT INTO Odsek (id, Ime, [Br. sprata], Ministarstvoid) VALUES (9,'Odsek za dugove', 2, 2);

INSERT INTO Odsek (id, Ime, [Br. sprata], Ministarstvoid) VALUES (10,'Odsek za izgradnju puteva', 1, 3);
INSERT INTO Odsek (id, Ime, [Br. sprata], Ministarstvoid) VALUES (11,'Odsek za renoviranje parkova', 2, 3);
...
INSERT INTO Radnik (id, Ime, Prezime, Pol, [Br. legitimacije], [Godina rođenja], Odsekid) VALUES (11, 'Stefan', 'Prvulovic', 'M', 6425766, 1997, 8)
INSERT INTO Radnik (id, Ime, Prezime, Pol, [Br. legitimacije], [Godina rođenja], Odsekid) VALUES (12, 'Kristina', 'Prvulovic', 'Ž', 6412345, 2002, 9)

INSERT INTO Radnik (id, Ime, Prezime, Pol, [Br. legitimacije], [Godina rođenja], Odsekid) VALUES (13, 'Jana', 'Nikolic', 'Ž', 6424586, 1997, 10)
INSERT INTO Radnik (id, Ime, Prezime, Pol, [Br. legitimacije], [Godina rođenja], Odsekid) VALUES (14, 'Marijana', 'Perovic', 'Ž', 7585111, 1997, 11)
